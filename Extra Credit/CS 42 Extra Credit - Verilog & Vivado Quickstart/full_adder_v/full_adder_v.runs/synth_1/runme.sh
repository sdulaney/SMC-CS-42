...
HD_PWD='C:/Users/Stewart Dulaney/Documents/Vivado Projects/full_adder_v/full_adder_v.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log full_adder_v.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source full_adder_v.tcl
